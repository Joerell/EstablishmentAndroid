...
public class ActiveList_Adapter extends FirestoreRecyclerAdapter<Location_Model, ActiveList_Adapter.ActiveListHolder> {
    private OnItemClicklistener listener;
    public ActiveList_Adapter(@NonNull FirestoreRecyclerOptions<Location_Model> options) {
        super(options);
    }
    ...
    public ActiveListHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_active_list_adapter,parent, false);
