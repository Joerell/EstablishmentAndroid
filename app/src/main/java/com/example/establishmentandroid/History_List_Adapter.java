...
public class History_List_Adapter extends FirestoreRecyclerAdapter<Location_Model, History_List_Adapter.HistoryHolder> {

public History_List_Adapter(@NonNull FirestoreRecyclerOptions<Location_Model> options) {
        super(options);
        }
...
public HistoryHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_history_list_adapter,parent, false);
